...
debug: MoCo.cpp
	@$(CC) $(DFLAG) $(CFLAGS) MoCo.cpp -o MoCo $(VTK_DYN_LIBS) -I$(VTK_INCLUDE_DIR)

dynamic: MoCo.cpp
	@$(CC) $(CFLAGS) MoCo.cpp -o MoCo $(VTK_DYN_LIBS) -I$(VTK_INCLUDE_DIR)

static:
	@$(CC) $(CFLAGS) MoCo.cpp -o MoCo $(VTK_STA_LIBS) -I$(VTK_INCLUDE_DIR)